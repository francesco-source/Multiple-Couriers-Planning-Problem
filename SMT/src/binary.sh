...
do 
    ...
    do
    : '
     if the solution is unsat and no
     feasible solutions have been found -> exit
    ...
    '
     ...
     one_sat=1 #if it's sat at least one time
     case $text in
        sat)   sat=1;;
        unsat) sat=0;;
        esac
